...
verts : [ { x:0        , y:c.peice_depth, z:0 }
	...
	, { x:c.inset*2+c.inset_pad, y:c.peice_depth    , z:0 }
	, { x:c.inset+c.inset_pad , y:c.peice_depth, z:c.inset  }
	, { x:c.inset*2+c.inset_pad, y:c.peice_depth, z:c.inset  }
	...
	, { x:c.inset*2+c.inset_pad, y:c.peice_depth-c.inset_depth, z:c.inset+c.inset_pad } 

	, { x:0, y:c.peice_depth, z:c.inset*2+c.inset_pad }
	, { x:c.inset, y:c.peice_depth, z:c.inset*2+c.inset_pad } 
	, { x:c.inset+c.inset_pad, y:c.peice_depth-c.inset_depth, z:c.inset*2+c.inset_pad } 
...
faces : [ [0,5,6],[0,6,3],[0,3,1],[1,3,2],[3,4,2],[5,9,6],[9,10,6]
	, [15,16,13],[13,16,14],[16,17,14],[15,18,19],[18,19,16] 
	],
scaledVert(n,scale) { return this.verts[n]; }
},
inset_left_fill:{
verts : [ { x:0        , y:c.peice_depth, z:c.inset_depth*2+c.inset_pad }
	, { x:c.inset, y:c.peice_depth    , z:c.inset_depth*2+c.inset_pad }
	, { x:c.inset+c.inset_pad, y:c.peice_depth-c.inset_depth    , z:c.inset_depth*2+c.inset_pad }
	, { x:c.inset*2+c.inset_pad, y:c.peice_depth-c.inset_depth  , z:c.inset_depth*2+c.inset_pad }

	, { x:0        , y:c.peice_depth, z:c.top_hbar_height-(c.inset_depth*2+c.inset_pad) }
	, { x:c.inset, y:c.peice_depth    , z:c.top_hbar_height-(c.inset_depth*2+c.inset_pad) }
	, { x:c.inset+c.inset_pad, y:c.peice_depth-c.inset_depth    , z:c.top_hbar_height-(c.inset_depth*2+c.inset_pad) }
	, { x:c.inset*2+c.inset_pad, y:c.peice_depth-c.inset_depth  , z:c.top_hbar_height-(c.inset_depth*2+c.inset_pad) }

        ],
norms : [ { x:0.1, y : 1, z: 0 }, { x:0, y : 1, z: 0 }, { x:0.1, y : 1, z: 0 }, { x:0, y:1, z:0 } // top flat of inset
	, { x:0.5, y:0.5, z:0 }
        ],
pairs : [ [0,0], [1,1], [3, 2]
	, [4,0],[5,1],[6,2],[7,3]
...
faces : [ [ 0, 4, 1 ], [4, 5, 1],[8,10,9],[10,11,9],[1,5,2],[4,6,2]
	//, [ 2,6,3],[6,7,3]
	],
scaledVert(n,scale) { return this.verts[n]; }
},
...
inset_background:{
verts : [ { x:0        , y:c.peice_depth-c.inset_depth, z:0 }, { x:c.unit_length, y:c.peice_depth-c.inset_depth    , z:0 }
	, { x:0        , y:c.peice_depth-c.inset_depth, z:c.unit_length }, { x:c.unit_length, y:c.peice_depth-c.inset_depth, z:c.unit_length  }
        ],
...
verts : [ { x:0        , y:c.peice_depth -c.inset_depth/2    , z:0 }, { x:c.unit_length, y:c.peice_depth-c.inset_depth/2    , z:0 }
	, { x:0        , y:c.peice_depth-c.inset_depth/2, z:c.top_hbar_height  - (c.inset*2+c.inset_pad)  }, { x:c.unit_length, y:c.peice_depth-c.inset_depth/2, z:c.top_hbar_height - (c.inset*2+c.inset_pad)  }
        ],
norms : [ { x:0, y : 1, z: -0.1 }
	, { x:0, y : 1, z: 0.1 }
        ],
...
function initRight() {
	...
	shape.inset_right.pairs = shape.inset_left.pairs;
	let f = shape.inset_right.faces = shape.inset_left.faces.slice(0);
	for( i = 0; i < v.length; i++ ) {
		v[i].x = (c.inset*2+c.inset_pad*2) - v[i].x;
	}
