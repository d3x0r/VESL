...
verts : [ { x:0, y:c.peice_depth, z:0 }, { x:(c.htab_width/2)-c.htab_base_width/2, y : c.peice_depth, z:0 } // 0-1
	...
	, { x: c.htab_width/2 - c.tab_base_width/2 - (c.htab_height / (c.htab_width-c.htab_tip_width) ) * c.swell_pad, y:c.peice_depth*3/4, z:c.swell_pad }
	...
	, { x: c.htab_width/2 - c.tab_base_width/2 - (c.htab_height / (c.htab_width-c.htab_tip_width) ) * c.swell_pad, y:c.peice_depth*1/4, z:c.swell_pad }
	...
	, { x:c.htab_width/2 + c.htab_tip_width/2,y:0,z:c.htab_height } //20
        ...
        , { x:0, y:0, z:0 }, { x:(c.htab_width/2)-c.htab_base_width/2, y : 0, z:0 }
	, { x:c.htab_width/2, y:0, z:0}, { x:(c.htab_width/2)+c.htab_base_width/2, y:0,z:0}
...
faces : [ [0,1,2], [3,1,0],[0,2,4]
	, [5,11,6],[11,12,6],[6,12,13],[12,13,7],[7,13,14],[13,14,8],[8,14,15],[14,15,9],[9,15,16],[15,16,10]
	, [11,17,12],[17,18,12],[12,18,19],[18,19,13],[13,19,20],[19,20,14],[14,20,21],[20,21,15],[15,21,22],[21,22,16]
	, [17,23,24],[23,24,18],[18,24,25],[24,25,19],[19,25,26],[25,26,20],[20,26,27],[26,27,21],[21,27,28],[27,28,22]
...
verts : [ { x: 0, y:c.peice_depth, z: c.htab_height+c.swell_pad }
	...
	, { x:c.htab_width/2-c.htab_base_width - 2*swell_x_offset, y:c.peice_depth, z:c.swell_pad }
	...
	, { x:c.htab_width/2-c.htab_base_width - 2*swell_x_offset, y:0, z:c.swell_pad }
...
pairs : [ [0,0],[1,0],[3,0],[4,0],[5,0],[6,0],[7,0],[8,0] // 0-7
	...
	, [21,15],[22,15],[23,15],[24,25],[25,15],[26,15],[27,15],[28,15] // 26-33
	],
faces : [ [4,0,5],[5,0,1],[6,2,3],[6,3,7]
	, [8,4,9],[4,5,9],[9,5,1],[5,1,10],[10,1,2],[1,2,11],[11,2,6],[2,6,12],[12,6,7],[6,7,13]
	, [ 14,8,9],[8,9,15],[15,9,10],[9,10,16],[16,10,11],[10,11,17],[17,11,12],[11,12,18],[18,12,13],[12,13,19]
	, [20,14,15],[14,15,21],[21,15,16],[15,16,22],[22,16,17],[16,17,23],[23,17,18],[17,18,24],[24,18,19],[18,19,25]
	, [30,26,21],[30,27,31],[32,28,33],[33,28,29]
	],
scaledVert(n,scale) { return this.verts[n]; }
},
...
verts : [ { z:0, y:c.peice_depth, x:(c.vtab_width+c.swell_pad)-0 }, { z:(c.vtab_height/2)-c.vtab_base_width/2, y : c.peice_depth, x:(c.vtab_width+c.swell_pad)-0 } // 0-1
	...
	, { z: c.vtab_height/2 - c.tab_base_width/2 - (c.vtab_width / (c.vtab_height-c.vtab_tip_width) ) * c.swell_pad, y:c.peice_depth*3/4, x:(c.vtab_width+c.swell_pad)-c.swell_pad }
	...
	, { z: c.vtab_height/2 - c.tab_base_width/2 - (c.vtab_width / (c.vtab_height-c.vtab_tip_width) ) * c.swell_pad, y:c.peice_depth*1/4, x:(c.vtab_width+c.swell_pad)-c.swell_pad }
...
verts : [ { z: 0, y:c.peice_depth, x:(c.vtab_width+c.swell_pad)- c.vtab_width+c.swell_pad }
	...
	// 25-28
	, { z: 0, y:0, x:(c.vtab_width+c.swell_pad)- c.vtab_width+c.swell_pad }
